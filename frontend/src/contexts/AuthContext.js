...
const AuthContext = createContext({
  ...
  logout: () => {},
  register: () => Promise.reject('Auth context not initialized'),
  forgotPassword: () => Promise.reject('Auth context not initialized'),
  resetPassword: () => Promise.reject('Auth context not initialized'),
  hasPermission: () => false,
  hasRole: () => false
});
